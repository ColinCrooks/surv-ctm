...
void cox_reg_accumulation(llna_model* model, gsl_matrix* sum_zbar_events_cumulative, corpus* c, int size, int rank, int bn,
...
void cox_reg_distr_init(llna_model* model, corpus* c, int size, int rank);
